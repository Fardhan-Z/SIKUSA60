    ...
    <div class="p-8 bg-gray-50 min-h-screen">
        ...
        <div class="bg-white rounded-2xl shadow-md overflow-hidden">
                        ...
                        <tr class="user-row hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="px-6 py-4 searchable">
                                ...
                                @elseif ($item->status == 'Diproses')
                                    <span class="px-3 py-1 text-xs rounded-full bg-blue-500 text-white">
                                        Diproses
                                    </span>
                                @else
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <a href="{{ route('siswa.pengaduan.show', $item->id) }}"
            ...
            text-white shadow transition">
                                    ...
                                    @if ($item->status === 'Menunggu')
                                        <a href="{{ route('siswa.pengaduan.edit', $item->id) }}"
                                            class="px-3 py-1 text-xs rounded-full
                ...
                text-white shadow transition">
                                        ...
                                        <form action="{{ route('siswa.pengaduan.destroy', $item->id) }}" method="POST"
